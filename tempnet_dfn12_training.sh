...
data_path=/scratch/group/optmai/datasets/dfn2b/medium/shards # Base data path 
imagenet_val_path=/scratch/group/optmai/datasets/imagenet/val # Updated ImageNet path
train_image_root=/scratch/group/optmai/datasets/dfn2b/medium/shards # New CC3M train path  
data=dfn_med
...
srun python -u  clip_cc12m.py \
    --train-data '/scratch/group/optmai/datasets/dfn2b/medium/shards/{00000000..00001926}.tar' \
    --train-num-samples 12025856 --data_size 12025856 \
