...
def main(args):
    ...
    if args.data in ['sbu', 'cc3m']:
        train_dataset = create_train_dataset('re', args)
    elif args.data in ['cc12m']:
        train_dataset = create_train_dataset_for_cc12m('re',args)
    else:
    ...
    train_loader = create_train_loader(train_dataset, samplers[0], args.batch_size_train, num_workers = 2, collate_fn = None, drop_last=False)
    ...
    if args.text_encoder == 'roberta-large':
        ...
        # text_model = AutoModel.from_pretrained(args.text_encoder, local_files_only=False)
